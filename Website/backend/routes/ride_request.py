...
def ride_request():
    try:
        ...
        distance_to_pickup, duration_to_pickup, path_to_pickup = get_trip_updates(ride.id)
        distance_to_dropoff, duration_to_dropoff, path_to_dropoff = get_trip_updates(ride.id)
...
def get_trip_updates(trip_id):
    ...
    return distance_to_pickup, duration_to_pickup, path_to_pickup
